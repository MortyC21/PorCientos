...
/*
   ...
   PorCientos is a charity token.
    ...
    Telegram: https://t.me/PorCientos
    Twitter: https://twitter.com/PorCientos
    Website: https://porcientos.com

    Whitepaper: https://porcientos.com/whitepaper
...
contract PorCientos is Context, IERC20, Ownable {
    ...
    string private _name = "PorCientos";
    ...
    uint256 public _maxTxAmount = 1 * 10**12 * 10**8;
    uint256 private minimumTokensBeforeSwap = 5 * 10**5 * 10**8; 
